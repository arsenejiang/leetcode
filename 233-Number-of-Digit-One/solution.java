public class Solution {
    public int countDigitOne(int n) {
        ...
        for(long m = 1; m <= n; m *= 10) {
            ...
            // n / m % 10 == 1 to check if the digit is 1, if the digit is 1
            // The digitOne count in current digit is controlled by (n % m + 1) which is all the digits on the right side of current digit
